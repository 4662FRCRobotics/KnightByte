 ...
 *
 */
public class LoaderArmLaunch extends Command {
	double m_speed = 0.5;
    ...
    protected void execute() {
    	if (RobotMap.LoaderPark.get() == false && RobotMap.LoaderLaunch.get() == true) {
    		m_speed = m_speed * -1;
    	}
    	Robot.loaderArms.parkLoaderArm(m_speed);
    }

    // Make this return true when this Command no longer needs to run execute()
    protected boolean isFinished() {
    	return ((RobotMap.LoaderLaunch.get() == false)|| isTimedOut());
